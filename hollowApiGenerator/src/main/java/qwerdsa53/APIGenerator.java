...
public class APIGenerator {
    ...
    private static final String GENERATED_API_NAME = "UserAPI";
    
    private static final String DATA_MODEL_PACKAGE = "qwerdsa53.model";
    private static final String GENERATED_API_PACKAGE = "qwerdsa53.api.generated";
    ...
    /**
     * Assumption: The root project folder contains a file called 'pom.xml'
     */
    private static boolean containsPomXml(File f) {
        return f.listFiles((dir, name) -> name.equals("pom.xml")).length > 0;
    }
